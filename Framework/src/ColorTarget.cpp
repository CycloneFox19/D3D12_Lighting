...
)
{
	...
	// if you use sRGB format, it selects sRGB format
	if (useSRGB)
	{
...
// get descriptor handle for RTV
DescriptorHandle* ColorTarget::GetHandleRTV() const
{
	return m_pHandleRTV;
}

// get descriptor handle for SRV
...
// get configuration of render target view
D3D12_RENDER_TARGET_VIEW_DESC ColorTarget::GetRTVDesc() const
{
	return m_RTVDesc;
}

// get configuration of shader resource view
